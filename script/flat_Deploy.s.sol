...
/** 
 *  SourceUnit: c:\Users\Alikhan\OneDrive\Blockchain_Technology\Blockchain2_FINAL_Alikhan_Zarina\script\Deploy.s.sol
*/
...
contract Deploy is Script {
    function run() external {
        ...
        TimelockController timelock = new TimelockController(2 days, proposers, executors, vm.addr(deployerKey));
    ...
    function _handoffRegistryAdmin(AssetRegistry registry, TimelockController timelock) internal {
        ...
        registry.renounceRole(registry.UPGRADER_ROLE(), msg.sender);
        registry.renounceRole(registry.ISSUER_ADMIN_ROLE(), msg.sender);
        registry.renounceRole(registry.PAUSER_ROLE(), msg.sender);
        registry.renounceRole(registry.DEFAULT_ADMIN_ROLE(), msg.sender);
    }
        ...
        internal
    {
        ...
        assetToken.renounceRole(assetToken.MINTER_ROLE(), msg.sender);
        assetToken.renounceRole(assetToken.BURNER_ROLE(), msg.sender);
        assetToken.renounceRole(assetToken.DEFAULT_ADMIN_ROLE(), msg.sender);
